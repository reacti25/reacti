...
final class CancelRequestRx extends RxResponseInt<Map> {
  /// Creates the Rx data source; [empty] and [dataFetcher] are forwarded to
  /// [RxResponseInt].
  CancelRequestRx({required super.empty, required super.dataFetcher});
  ...
  final api = CancelRequestApi.instance;
