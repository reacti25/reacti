                    ...
                    <div class="card product-sales-main">
                        <div class="card-header border-bottom">
                            ...
                            <div class="card-options ms-auto">
                                <a href="{{ route('admin.faq.create') }}" class="btn btn-primary btn-sm">Add FAQ</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="">
                                <table class="table text-nowrap mb-0 table-bordered" id="datatable">
                                    <thead>
                                        <tr>
                                            ...
                                            {{-- <th class="bg-transparent border-bottom-0 wp-15">For (Buyer || Seller)</th> --}}
                                            <th class="bg-transparent border-bottom-0 wp-10">Status</th>
                                            <th class="bg-transparent border-bottom-0 wp-10">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
