            ...
            <div class="row">
                <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                    <div class="card box-shadow-0">
                        <div class="card-body">
                            <form method="post" action="{{ route('setting.stripe.update') }}" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control @error('stripe_key') is-invalid @enderror" id="stripe_key"
                                            ...
                                            value="{{ config('services.stripe.key') ?? old('stripe_key') }}"
>
                                        @error('stripe_key')
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control @error('stripe_secret') is-invalid @enderror" id="stripe_secret"
                                            ...
                                            value="{{ config('services.stripe.secret') ?? old('stripe_secret') }}">
                                        @error('stripe_secret')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control @error('stripe_webhook_secret') is-invalid @enderror" id="stripe_webhook_secret"
                                            ...
                                            value="{{ config('services.stripe.webhook_secret') ?? old('stripe_webhook_secret') }}">
