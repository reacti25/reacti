@extends('backend.app', ['title' => 'Dynamic Pages'])
                    ...
                    <div class="col-12 col-sm-12">
                        <div class="card product-sales-main">
                            <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                                <h3 class="card-title mb-0">Dynamic Pages</h3>
                                <a href="{{ route('admin.dynamic_page.create') }}" class="btn btn-primary btn-sm">
                                    ...
                                    <table class="table text-nowrap mb-0 table-bordered" id="datatable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="bg-transparent border-bottom-0 wp-10">Page Title</th>
                                                <th class="bg-transparent border-bottom-0 wp-50">Page Content</th>
