                               ...
                               <div class="row mb-4">
                                    ...
                                    <div class="col-md-9">
                                         <input class="form-control @error('mail_mailer') is-invalid @enderror" id="mail_mailer"
                                            ...
                                            value="{{ old('mail_mailer', config('mail.default')) }}">
                                        @error('mail_mailer')
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control @error('mail_encryption') is-invalid @enderror"
                                            ...
                                            type="text" value="{{ old('mail_encryption', env('MAIL_ENCRYPTION')) }}">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control @error('mail_from_address') is-invalid @enderror"
                                            ...
                                            type="text" value="{{ old('mail_from_address', env('MAIL_FROM_ADDRESS')) }}">
