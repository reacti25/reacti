@extends('backend.app', ['title' => 'Specializes'])

@section('title', 'Dashboard || Specializes')
                    ...
                    <div class="col-12 col-sm-12">
                        <div class="card product-sales-main">
                            <div class="card-header border-bottom">
                                <h3 class="card-title mb-0">Specialize List</h3>
                                <div class="card-options ms-auto">
                                    <a href="{{ route('admin.specialize.create') }}" class="btn btn-primary btn-sm">Add
                                        Specialize</a>
        ...
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#datatable')) {
                let dTable = $('#datatable').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('admin.specialize.index') }}",
                        type: "GET",
                    },
                    columns: [{
                            data: 'DT_RowIndex',
            ...
            function statusChange(id) {
                NProgress.start();
                let url = "{{ route('admin.specialize.status', ':id') }}";
                $.ajax({
                    type: "POST",
         ...
         function showDeleteConfirm(id) {
            ...
            function deleteItem(id) {
                NProgress.start();
                let url = "{{ route('admin.specialize.destroy', ':id') }}";
